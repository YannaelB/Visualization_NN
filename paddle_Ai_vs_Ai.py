...
class Paddle():
    ...
    def update_screen(self):
        ...
        text = pygame.font.Font('arial.ttf', 20).render(" AI 1 ", True, BLACK)
        ...
        text = pygame.font.Font('arial.ttf', 20).render(" AI 2 ", True, BLACK)
